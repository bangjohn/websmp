...
<body>
  <nav class="white" role="navigation">
    <div class="nav-wrapper container">
      ...
      <ul class="right hide-on-med-and-down">
		...
		<li class="active"><a href="#">Akademik</a></li>
 ...
 <div id="index-banner" class="parallax-container">
  ...
  <div class="container">
  <br><br>
        <h1 class="header center teal-text text-accent-3">Akademik</h1>
        <div class="row center">
          <p class="left-align">
			<a href="https://www.w3schools.com">Pramuka</a><br>
			<a href="https://www.w3schools.com">Palang Merah Remaja</a><br>
			<a href="https://www.w3schools.com">Olahraga</a>
		  </p>
        </div>
        <br><br>
