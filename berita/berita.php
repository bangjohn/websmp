...
<body>
 ...
 <div id="index-banner" class="parallax-container">
  ...
  <div class="container">
  <br><br>
        <h1 class="header center teal-text text-accent-3">Berita</h1>
...
while($row = mysql_fetch_assoc($member)) { ?> 
	<tr>
		<td align="center"><h5><b><?= $row['judul']; ?></b></h5></td><br>
		<td align="center"><?= $row['waktu']; ?></td><br><br>
...
<?php } ?>
     <br><br><br>
	 <tr>
		<td><a href="insertberita.php"><input type='submit' value=''></a></td>
	</tr>
			</div>
		</div>
		</div>
