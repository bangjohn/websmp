    ...
    <div class="section">
      ...
      <div class="row">
        <div class="col s12 center">
          ...
          <p><img src="pm.JPG" height="10%" width="20%" align="middle">     <img src="pm1.JPG" height="10%" width="20%" align="middle"> 
</p>
<h2>PENDIDIKAN DAN PELATIHAN PMR</h2>
<p>
...
<H2>TRIBAKTI PMR</H2>
<p>
dalam PMR ada tugas yang harus dilaksanakan, dalam PMR dikenal tri bakti yang harus diketahui, dipahami dan dilaksanakan oleh semua anggota. TRIBAKTI PMR (2009) tersebut adalah:<BR>
1.	Meningkatkan keterampilan hidup sehat<BR>
2.	Berkarya dan berbakti kepada masyarakat<BR>
3.	Mempererat persahabatan nasional dan internasional.
</p>
<H2>TINGKATAN PMR</H2>
<p>
Di Indonesia dikenal ada 3 tingkatan PMR sesuai dengan jenjang pendidikan atau usianya<BR>
1.	PMR Mula adalah PMR dengan tingkatan setara pelajar Sekolah Dasar (10-12 tahun). Warna emblem Hijau<BR>
2.	PMR Madya adalah PMR dengan tingkatan setara pelajar Sekolah Menengah Pertama (12-15 tahun). Warna emblem Biru Langit<BR>
3.	PMR Wira adalah PMR dengan tingkatan setara pelajar Sekolah Menengah Atas (15-17 tahun). Warna emblem Kuning<BR>
</p>
        </div>
      </div>
...
<table align="center" style="width:80%"; border="0">
	...
	<h3 align="center">Anggota PMR SMP KITA</h3>
	<th>No.</th>
	<th>N0.Induk</th>
	<th>Nama</th>
	<th>Alamat</th>
